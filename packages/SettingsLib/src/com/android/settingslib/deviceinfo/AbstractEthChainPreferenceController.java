 ...
 * class.
 */
public abstract class AbstractEthChainPreferenceController extends AbstractPreferenceController {

    protected Preference mPreference;

    public AbstractEthChainPreferenceController(Context context) {
        super(context);
    }
