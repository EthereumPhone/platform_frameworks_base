 ...
 */
public abstract class AbstractEthNounsPreferenceController
        extends AbstractConnectivityPreferenceController {

    @VisibleForTesting
    static final String KEY_ETH_ADDRESS = "funded_by_nouns";
    ...
    public AbstractEthNounsPreferenceController(Context context, Lifecycle lifecycle) {
	...
	mEthAddress.setSummary("Fuck yes ⌐◨-◨");
    }
}
